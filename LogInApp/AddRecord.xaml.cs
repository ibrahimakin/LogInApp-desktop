    ...
    public partial class AddRecord : UserControl
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                ((IUpdateCount)System.Windows.Application.Current.MainWindow).UpdateTotalCount();  // Update number of Records in MainWindow through the IUpdateCount interface
                ((IUpdateCount)System.Windows.Application.Current.MainWindow).UpdateFilterCount(); // Update number of Records in MainWindow through the IUpdateCount interface
